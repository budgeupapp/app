 ...
 */
export default function CategoryStep({ categoryId, entries = [], entryTotals = null, entryRemovedCounts = null, entryOverrideCounts = null, updateEntries, compact = false, onVisibleEntryChange = null, onDeleteEntry = null, onClearEntryEvents = null }) {
    ...
    return (
        <IncomeExpenseCard
            ...
            onClearEntryEvents={onClearEntryEvents}
        />
    )
}
