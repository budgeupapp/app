        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
            ...
            <div style={{ flex: 1, overflowY: 'visible', overflowX: 'hidden', WebkitOverflowScrolling: 'touch', padding: compact ? '0 24px 8px' : '0 24px 16px', display: 'flex', flexDirection: 'column' }} ref={scrollRef}>
                ...
                {(() => {
                    ...
                    return (
                        <>
                            <p ref={questionRef} style={{ fontSize: 14, fontWeight: 700, fontFamily: 'Nunito, sans-serif', color: '#000', margin: '0 0 8px' }}>How much do they send you?</p>
                ...
                {amountPeriod === 'yearly' ? (
                    <div ref={datesBoxRef} style={{ background: 'rgba(20,123,117,0.1)', borderRadius: 10, padding: '10px 12px' }}>
                        <p style={{ fontSize: 14, fontWeight: 600, fontFamily: 'Nunito, sans-serif', color: '#000', margin: '0 0 8px' }}>How often do they send it?</p>
